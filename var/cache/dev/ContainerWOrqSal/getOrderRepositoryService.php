...
{
    /**
     * Gets the private 'App\Repository\article\OrderRepository' shared autowired service.
     *
     * @return \App\Repository\article\OrderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'article'.\DIRECTORY_SEPARATOR.'OrderRepository.php';

        return $container->privates['App\\Repository\\article\\OrderRepository'] = new \App\Repository\article\OrderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
