...
{
    /**
     * Gets the private 'App\Repository\article\ArticleRepository' shared autowired service.
     *
     * @return \App\Repository\article\ArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'article'.\DIRECTORY_SEPARATOR.'ArticleRepository.php';

        return $container->privates['App\\Repository\\article\\ArticleRepository'] = new \App\Repository\article\ArticleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
