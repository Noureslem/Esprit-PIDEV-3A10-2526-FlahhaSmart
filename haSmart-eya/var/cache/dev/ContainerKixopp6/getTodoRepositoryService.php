...
{
    /**
     * Gets the private 'App\Repository\article\TodoRepository' shared autowired service.
     *
     * @return \App\Repository\article\TodoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'article'.\DIRECTORY_SEPARATOR.'TodoRepository.php';

        return $container->privates['App\\Repository\\article\\TodoRepository'] = new \App\Repository\article\TodoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
