...
";
    ...
    <nav class=\"mt-2\">
        ...
        ";
            ...
            <a class=\"nav-link ";
                // line 73
                if ((is_string($_v0 = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 73, $this->source); })()), "request", [], "any", false, false, false, 73), "attributes", [], "any", false, false, false, 73), "get", ["_route"], "method", false, false, false, 73)) && is_string($_v1 = "app_article_") && str_starts_with($_v0, $_v1))) {
                    yield "active";
                }
                yield "\" href=\"";
        ...
        ";
            ...
            <a class=\"nav-link ";
                // line 86
                if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 86, $this->source); })()), "request", [], "any", false, false, false, 86), "attributes", [], "any", false, false, false, 86), "get", ["_route"], "method", false, false, false, 86) == "dashboard_client")) {
                    yield "active";
                }
                yield "\"
               href=\"";
     ...
     <a class=\"nav-link ";
            // line 97
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 97, $this->source); })()), "request", [], "any", false, false, false, 97), "attributes", [], "any", false, false, false, 97), "get", ["_route"], "method", false, false, false, 97) == "app_profile")) {
                yield "active";
            }
            yield "\" 
   href=\"";
...
";
    ...
    ";
        // line 111
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 111, $this->source); })()), "user", [], "any", false, false, false, 111)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 112
        ...
        <div class=\"d-flex align-items-center gap-3\">
            ...
            // line 118
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 118, $this->source); })()), "user", [], "any", false, false, false, 118), "role", [], "any", false, false, false, 118), "html", null, true);
            yield "</span>
        </div>
    </div>
    ";
...
";
    ...
    {
        return array (  414 => 136,  392 => 132,  369 => 114,  347 => 38,  324 => 6,  312 => 137,  310 => 136,  305 => 133,  303 => 132,  300 => 131,  294 => 130,  284 => 126,  279 => 125,  274 => 124,  270 => 123,  267 => 122,  260 => 118,  256 => 117,  250 => 114,  246 => 112,  244 => 111,  235 => 110,  232 => 108,  223 => 102,  216 => 98,  210 => 97,  205 => 94,  195 => 87,  189 => 86,  186 => 85,  167 => 73,  160 => 69,  154 => 68,  151 => 67,  138 => 57,  132 => 56,  129 => 55,  127 => 54,  118 => 50,  114 => 49,  110 => 48,  104 => 44,  102 => 43,  97 => 39,  95 => 38,  60 => 6,  53 => 1,);
    }
...
<div class=\"sidebar\">
    ...
    <nav class=\"mt-2\">
        ...
        {% elseif is_granted('ROLE_AGRICULTEUR') %}
            ...
            <a class=\"nav-link {% if app.request.attributes.get('_route') starts with 'app_article_' %}active{% endif %}\" href=\"{{ path('app_article_index') }}\">
                <i class=\"bi bi-box\"></i> Mes articles
            </a>
