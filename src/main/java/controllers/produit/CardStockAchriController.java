...
public class  CardStockAchriController {
    ...
    private StockAgrichController parent;

    public void setData(StockProduit p, StockAgrichController parentController) {
        this.produit = p;
        ...
        if (parent != null) {
            ...
            alert.showAndWait().ifPresent(response -> {
                if (response == javafx.scene.control.ButtonType.OK) {
                    parent.deleteProduit(produit.getIdProduit());
                }
            });
        } else {
