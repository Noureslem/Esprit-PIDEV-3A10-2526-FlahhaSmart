...
class Operation
{
    ...
    #[Assert\NotNull(message: 'validators.operation.date_debut.not_null')]
    ...
    #[ORM\Column(type: Types::DATE_MUTABLE)]
    #[Assert\NotNull(message: 'validators.operation.date_fin.not_null')]
    #[Assert\GreaterThanOrEqual(
        propertyPath: 'date_debut',
        message: 'validators.operation.date_fin.after_or_equal_date_debut'
    )]
