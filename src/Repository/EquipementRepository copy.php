...
class EquipementRepository extends ServiceEntityRepository
{
    ...
    /**
     * Search equipements with filters
     */
    ...
    public function countReserved(): int
    {
        return (int) $this->createQueryBuilder('e')
            ->select('COUNT(e.id_equipement)')
            ->andWhere("LOWER(e.etat) = 'reserve' OR LOWER(e.etat) = 'réservé'")
            ->getQuery()
            ->getSingleScalarResult();
    }
    ...
    public function groupByType(): array
    {
        return $this->createQueryBuilder('e')
            ->select('e.type, COUNT(e.id_equipement) as count')
            ->groupBy('e.type')
            ->orderBy('count', 'DESC')
            ->getQuery()
            ->getResult();
     ...
     */
    public function findByName(string $name): ?Equipement
    {
        return $this->createQueryBuilder('e')
            ->andWhere('e.nom = :nom')
