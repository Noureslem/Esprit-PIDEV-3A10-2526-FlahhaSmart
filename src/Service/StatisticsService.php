...
class StatisticsService
{
    ...
    /**
     * Lightweight admin sidebar counters for badges.
     */
    public function getAdminSidebarCounts(): array
    {
        return [
            'operationsActive' => $this->operationRepository->countInProgress(),
            'operationsCritical' => $this->operationRepository->countCritical(2),
            'equipementMaintenance' => $this->equipementRepository->countByEtat('maintenance'),
            'equipementReserved' => $this->equipementRepository->countReserved(),
        ];
    }
