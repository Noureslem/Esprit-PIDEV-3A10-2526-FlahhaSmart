...
class __TwigTemplate_c3db2891a702f8abad93c13deaa329ce extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Modifier l'article - FlahaSmart";
    ...
    public function block_page_title(array $context, array $blocks = []): iterable
    {
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 4, $this->source); })()), "id", [], "any", false, false, false, 4), "html", null, true);
    ...
    <div class=\"card-header bg-white\">
        <h1 class=\"h3 mb-0\">Modifier l'article #";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 9, $this->source); })()), "id", [], "any", false, false, false, 9), "html", null, true);
        yield "</h1>
    </div>
    <div class=\"card-body\">
        ";
...
";
    ...
    {
        return array (  148 => 16,  144 => 15,  139 => 13,  135 => 12,  129 => 9,  125 => 7,  112 => 6,  88 => 4,  65 => 3,  42 => 1,);
    }
...
{% block title %}Modifier l'article - FlahaSmart{% endblock %}
{% block page_title %}Modifier l'article #{{ article.id }}{% endblock %}

{% block body %}
<div class=\"card\">
    <div class=\"card-header bg-white\">
        <h1 class=\"h3 mb-0\">Modifier l'article #{{ article.id }}</h1>
    </div>
    <div class=\"card-body\">
        {{ form_start(form) }}
        {{ form_widget(form) }}
        <button type=\"submit\" class=\"btn btn-primary mt-3\">Mettre à jour</button>
        <a href=\"{{ path('app_article_index') }}\" class=\"btn btn-secondary mt-3\">Annuler</a>
        {{ form_end(form) }}
    </div>
</div>
{% endblock %}", "article/edit.html.twig", "C:\\xampp\\htdocs\\Esprit-PIDEV-3A10-2526-FlahhaSmart-bachar-integration\\src\\templates\\article\\edit.html.twig");
    }
}
