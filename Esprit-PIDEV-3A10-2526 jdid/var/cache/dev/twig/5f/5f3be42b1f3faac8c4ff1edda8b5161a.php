...
class __TwigTemplate_ed86e386ead97699ffa4496122820d48 extends Template
{
    ...
    <div class=\"card-header bg-white\">
        <h1 class=\"h3 mb-0\">Modifier la commande #";
        // line 8
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 8, $this->source); })()), "id", [], "any", false, false, false, 8), "html", null, true);
        yield "</h1>
    </div>
    <div class=\"card-body\">
        ";
...
";
    ...
    {
        return array (  123 => 15,  119 => 14,  114 => 12,  110 => 11,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<div class=\"card\">
    <div class=\"card-header bg-white\">
        <h1 class=\"h3 mb-0\">Modifier la commande #{{ order.id }}</h1>
    </div>
    <div class=\"card-body\">
        {{ form_start(form) }}
        {{ form_widget(form) }}
        <button type=\"submit\" class=\"btn btn-primary mt-3\">Mettre à jour</button>
        <a href=\"{{ path('app_order_index') }}\" class=\"btn btn-secondary mt-3\">Annuler</a>
        {{ form_end(form) }}
    </div>
</div>
{% endblock %}", "order/edit.html.twig", "C:\\xampp\\htdocs\\Esprit-PIDEV-3A10-2526-FlahhaSmart-bachar-integration\\src\\templates\\order\\edit.html.twig");
    }
}
