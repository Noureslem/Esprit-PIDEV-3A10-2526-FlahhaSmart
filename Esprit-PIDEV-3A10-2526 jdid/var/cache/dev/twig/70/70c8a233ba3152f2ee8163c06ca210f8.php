...
class __TwigTemplate_8b3a08f4e862297b52a705344db0b8ad extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "article/stats_price.html.twig"));
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Statistiques des prix - FlahaSmart";
    ...
    <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            yield "            <div class=\"mb-2\">
                <strong>";
            // line 37
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["article"], "nom", [], "any", false, false, false, 37), "html", null, true);
            yield "</strong> - ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, $context["article"], "prix", [], "any", false, false, false, 37), 2, ",", " "), "html", null, true);
            yield " €
            ...
            yield "%\">
                        ";
            // line 40
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::round(((CoreExtension::getAttribute($this->env, $this->source, $context["article"], "prix", [], "any", false, false, false, 40) / (isset($context["max"]) || array_key_exists("max", $context) ? $context["max"] : (function () { throw new RuntimeError('Variable "max" does not exist.', 40, $this->source); })())) * 100)), "html", null, true);
            yield "%
                    </div>
                </div>
            </div>
...
";
    ...
    {
        return array (  197 => 48,  192 => 45,  181 => 40,  177 => 39,  170 => 37,  167 => 36,  163 => 35,  152 => 27,  143 => 21,  134 => 15,  124 => 7,  111 => 6,  88 => 4,  65 => 3,  42 => 1,);
    }
...
{% block title %}Statistiques des prix - FlahaSmart{% endblock %}
{% block page_title %} Statistiques des prix{% endblock %}
...
{% endblock %}", "article/stats_price.html.twig", "C:\\xampp\\htdocs\\Esprit-PIDEV-3A10-2526-FlahhaSmart-bachar-integration\\src\\templates\\article\\stats_price.html.twig");
    }
}
