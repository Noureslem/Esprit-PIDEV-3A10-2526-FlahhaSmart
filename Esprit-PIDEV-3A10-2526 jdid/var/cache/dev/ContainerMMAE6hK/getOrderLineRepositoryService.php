 ...
 */
class getOrderLineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\article\OrderLineRepository' shared autowired service.
     *
     * @return \App\Repository\article\OrderLineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'article'.\DIRECTORY_SEPARATOR.'OrderLineRepository.php';

        return $container->privates['App\\Repository\\article\\OrderLineRepository'] = new \App\Repository\article\OrderLineRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
