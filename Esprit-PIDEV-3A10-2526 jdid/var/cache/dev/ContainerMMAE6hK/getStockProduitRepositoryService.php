 ...
 */
class getStockProduitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StockProduitRepository' shared autowired service.
     *
     * @return \App\Repository\StockProduitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StockProduitRepository.php';

        return $container->privates['App\\Repository\\StockProduitRepository'] = new \App\Repository\StockProduitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
