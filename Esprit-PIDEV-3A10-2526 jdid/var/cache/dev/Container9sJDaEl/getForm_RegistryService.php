...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\ConsommationProduitType' => ['privates', 'App\\Form\\ConsommationProduitType', 'getConsommationProduitTypeService', true],
            ...
            'App\\Form\\StockProduitType' => ['privates', 'App\\Form\\StockProduitType', 'getStockProduitTypeService', true],
            'App\\Form\\article\\ArticleType' => ['privates', 'App\\Form\\article\\ArticleType', 'getArticleTypeService', true],
            'App\\Form\\article\\ImageUploadType' => ['privates', 'App\\Form\\article\\ImageUploadType', 'getImageUploadTypeService', true],
            'App\\Form\\article\\OrderType' => ['privates', 'App\\Form\\article\\OrderType', 'getOrderTypeService', true],
            'App\\Form\\article\\TodoType' => ['privates', 'App\\Form\\article\\TodoType', 'getTodoTypeService', true],
            ...
            'App\\Form\\ConsommationProduitType' => '?',
            'App\\Form\\ProfileFormType' => '?',
            'App\\Form\\RegistrationFormType' => '?',
            'App\\Form\\StockProduitType' => '?',
            'App\\Form\\article\\ArticleType' => '?',
            'App\\Form\\article\\ImageUploadType' => '?',
            'App\\Form\\article\\OrderType' => '?',
            'App\\Form\\article\\TodoType' => '?',
