...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\BackAdmin\\ProduitController' => 'getProduitControllerService',
            'App\\Controller\\BackAgriculteur\\ProduitController' => 'getProduitController2Service',
            ...
            'App\\Controller\\article\\ArticleController' => 'getArticleControllerService',
            'App\\Controller\\article\\CalendarController' => 'getCalendarControllerService',
            'App\\Controller\\article\\CartController' => 'getCartControllerService',
            'App\\Controller\\article\\ConsultantController' => 'getConsultantControllerService',
            'App\\Controller\\article\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\article\\OrderController' => 'getOrderControllerService',
            'App\\Controller\\article\\PriceEstimatorController' => 'getPriceEstimatorControllerService',
            'App\\Controller\\article\\ShopController' => 'getShopControllerService',
            'App\\Controller\\article\\TodoController' => 'getTodoControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SER7IoD+rr', 0, ($container->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+BzUr89I2d', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hnJ9ljH6+I', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cZucNeMsjY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\AuthController', 'App\\Controller\\BackAdmin\\ProduitController', 'App\\Controller\\BackAgriculteur\\ProduitController', 'App\\Controller\\DashboardController', 'App\\Controller\\Front\\ClientController', 'App\\Controller\\ProfileController', 'App\\Controller\\article\\ArticleController', 'App\\Controller\\article\\CalendarController', 'App\\Controller\\article\\CartController', 'App\\Controller\\article\\ConsultantController', 'App\\Controller\\article\\HomeController', 'App\\Controller\\article\\OrderController', 'App\\Controller\\article\\PriceEstimatorController', 'App\\Controller\\article\\ShopController', 'App\\Controller\\article\\TodoController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1SmZi9Xai0', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('c734XMgj0H', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('96ELr5p0xR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ConsommationProduitRepository' => ['privates', 'App\\Repository\\ConsommationProduitRepository', 'getConsommationProduitRepositoryService', true],
            'App\\Repository\\StockProduitRepository' => ['privates', 'App\\Repository\\StockProduitRepository', 'getStockProduitRepositoryService', true],
            ...
            'App\\Repository\\article\\ArticleRepository' => ['privates', 'App\\Repository\\article\\ArticleRepository', 'getArticleRepositoryService', true],
            'App\\Repository\\article\\OrderLineRepository' => ['privates', 'App\\Repository\\article\\OrderLineRepository', 'getOrderLineRepositoryService', true],
            'App\\Repository\\article\\OrderRepository' => ['privates', 'App\\Repository\\article\\OrderRepository', 'getOrderRepositoryService', true],
            'App\\Repository\\article\\TodoRepository' => ['privates', 'App\\Repository\\article\\TodoRepository', 'getTodoRepositoryService', true],
        ], [
            'App\\Repository\\ConsommationProduitRepository' => '?',
            'App\\Repository\\StockProduitRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\UsersRepository' => '?',
            'App\\Repository\\article\\ArticleRepository' => '?',
            'App\\Repository\\article\\OrderLineRepository' => '?',
            'App\\Repository\\article\\OrderRepository' => '?',
            'App\\Repository\\article\\TodoRepository' => '?',
        ])));
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'tattali'.\DIRECTORY_SEPARATOR.'calendar-bundle'.\DIRECTORY_SEPARATOR.'src/Resources/views'), '!Calendar');
        $a->addPath((\dirname(__DIR__, 4).'/src/templates'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'twig.default_path' => (\dirname(__DIR__, 4).'/src/templates'),
