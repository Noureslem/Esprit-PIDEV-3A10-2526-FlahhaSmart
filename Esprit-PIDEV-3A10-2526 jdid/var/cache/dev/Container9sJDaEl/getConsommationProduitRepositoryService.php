 ...
 */
class getConsommationProduitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConsommationProduitRepository' shared autowired service.
     *
     * @return \App\Repository\ConsommationProduitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConsommationProduitRepository.php';

        return $container->privates['App\\Repository\\ConsommationProduitRepository'] = new \App\Repository\ConsommationProduitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
